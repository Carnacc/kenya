...
const Contatti = () => {
  const [formData, setFormData] = useState({
    ...
    email: "",
    telefono: "",
    aiuto: "", // Questo è già vuoto, ma lo lascio per chiarezza
    messaggio: "",
  })
  ...
  const handleClick = () => {
    const url = `https://www.instagram.com/kenya_con_falcone/`;
  ...
  return (
    <div className="contatti-container">
      <div className="contatti-left">
        <h1 className="contatti-title">Contatti</h1>
        <h2 className="contatti-name">Falcone</h2>
        ...
        <div className="contact-info">
          ...
          <div className="contact-item">
            ...
            <span>kenyaconfalcone@gmail.com</span>
          </div>
        </div>

        <p className="social-text">Mi trovi anche sui social!</p>

        <div className="social-icons" onClick={handleClick}>
      ...
      <div className="contatti-right">
        <form onSubmit={handleSubmit} className="contact-form">
          ...
          <div className="form-group">
            <label htmlFor="aiuto">Come posso aiutarti?</label>
            <select id="aiuto" name="aiuto" value={formData.aiuto} onChange={handleChange} className="form-control">
